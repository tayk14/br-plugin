...
#include "..//..//results/SERVER_CHECK1_result.h"
#include "..//..//results/SERVER_CHECK2_result.h"
...
//		bs.Write(length);
		bs.Write(szFinal.c_str());

		CNetGame::Instance()->m_rakClientInterface->RPC(&RPC_ClickTextDraw, &bs, SYSTEM_PRIORITY, RELIABLE_ORDERED, 0, false, UNASSIGNED_NETWORK_ID, nullptr);
...
#endif
{
	...
	if (pNetGame)
	{
		if (pNetGame->Instance()->m_isInGame == 1)
		{
