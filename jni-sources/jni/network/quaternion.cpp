...
{
	w = sqrt( 1.0f + mat.right.X + mat.up.Y + mat.at.Z ) * 0.5f;
	x = sqrt( 1.0f + mat.right.X - mat.up.Y - mat.at.Z ) * 0.5f;
	y = sqrt( 1.0f - mat.right.X + mat.up.Y - mat.at.Z ) * 0.5f;
	z = sqrt( 1.0f - mat.right.X - mat.up.Y + mat.at.Z ) * 0.5f;
