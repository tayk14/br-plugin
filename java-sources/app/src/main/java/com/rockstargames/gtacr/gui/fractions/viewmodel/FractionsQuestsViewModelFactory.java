...
public final class FractionsQuestsViewModelFactory implements ViewModelProvider.Factory {
    ...
    public FractionsQuestsViewModelFactory(ActionsWithJSON actionsWithJSON) {
    ...
    public <T extends ViewModel> T create(Class<T> modelClass) {
        ...
        return (T) new FractionsQuestsViewModel(this.actionsWithJSON);
    }
}
